...
[![GitHub Pages Workflow Status](https://github.com/golden-mask/golden-mask.github.io/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/golden-mask/golden-mask.github.io/actions/workflows/pages/pages-build-deployment)

Welcome to the Golden Mask Blog repository! This repository hosts the static blog published at [golden-mask.github.io](https://golden-mask.github.io). Content is dynamically pulled from an original Blogger blog, converted to Markdown, and then built with Jekyll and deployed via GitHub Pages.
...
* **Static Site Generation:** Utilize [Jekyll](https://jekyllrb.com/) to transform Markdown posts into a fast and efficient static website.
* **Free & Reliable Hosting:** Leverage [GitHub Pages](https://pages.github.com/) for cost-effective and robust blog hosting.
* **Local Content Management:** Enable seamless editing and management of blog posts using [Obsidian](https://obsidian.md/) on your local machine via symbolic links.
...
```bash
git clone [https://github.com/golden-mask/golden-mask.github.io.git](https://github.com/golden-mask/golden-mask.github.io.git)
...
1. Open your terminal in the golden-mask.github.io repository directory.
...
- You can now open and edit any existing post in the `_posts/` folder using your preferred text editor, or directly within Obsidian (_if you set up the symbolic link_).

- To create a new post, create a new Markdown file in the `_posts/` folder following the format: `YYYY-MM-DD-your-post-title-slug.md` and ensure it includes [YAML front matter](https://jekyllrb.com/docs/front-matter/) at the top.

### Previewing Your Site Locally (Optional)
If you wish to preview your site using Jekyll before publishing:

1. Ensure you have Ruby, Jekyll, and Bundler installed.

2. In your repository's root directory, run:
```
Bash

bundle exec jekyll serve
```
3. Open your web browser and navigate to the address Jekyll provides (typically `http://127.0.0.1:4000`).

### Publishing to GitHub Pages
1. After syncing posts or making any local edits:

2. In your terminal, ensure you're in the repository's root directory.
...
```
GitHub Pages will automatically build and publish your site to [golden-mask.github.io](https://www.google.com/url?sa=E&source=gmail&q=https://golden-mask.github.io) within a few minutes.
